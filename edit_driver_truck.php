        ...
        <div class="main-content">
            ...
            <div class="dashboard-main-container">
                ...
                <form method="POST" action="">
                    ...
                    <input type="text" id="license_plate" name="license_plate" value="<?php echo htmlspecialchars($truck['license_plate'], ENT_QUOTES, 'UTF-8'); ?>" required>

                    <label for="truck_type">Truck Type:</label>
                    <input type="text" id="truck_type" name="truck_type" value="<?php echo htmlspecialchars($truck['truck_type'], ENT_QUOTES, 'UTF-8'); ?>" required>

                    <label for="capacity">Capacity (in KG):</label>
                    <input type="number" id="capacity" name="capacity" value="<?php echo htmlspecialchars($truck['capacity'], ENT_QUOTES, 'UTF-8'); ?>" required>
